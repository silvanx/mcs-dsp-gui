...
EDMA CSL 2x EXAMPLE 
====================
The folders in this directory contain a example that demonstrates the usage of EDMA CSL 2.x API's.
...
2. Open the Edma_Csl2x_Example.pjt in the CCS .
...
2. Open the Edma_Csl2x_Example.pjt in the CCS studio .
